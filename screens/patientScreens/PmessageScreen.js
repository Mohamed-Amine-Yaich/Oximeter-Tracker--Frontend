...
export default class PmessageScreenclass extends Component {
  constructor(props) {
    super(props);
    this.state = {
      msg: "",
...
/* use this function to wrap the class component because we need to pass 
the navigation object throw props to the class for assuring the opening and the
of the drawer with the top left button */
/* export default function PmessageScreen(props) {
    const navigation = useNavigation();
  
    return <PmessageScreenclass {...props} navigation={navigation} />;
  } */
